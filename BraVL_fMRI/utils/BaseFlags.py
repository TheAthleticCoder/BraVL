...
# DATA DEPENDENT
parser.add_argument(
    "--class_dim", type=int, default=32, help="dimension of common factor latent space"
)
# SAVE and LOAD
parser.add_argument(
    "--mm_vae_save", type=str, default="mm_vae", help="model save for vae_bimodal"
)
parser.add_argument(
    "--load_saved",
    type=bool,
...
parser.add_argument(
    "--text_model", type=str, default="GPTNeo", help="text embedding model"
)
parser.add_argument(
    "--image_model",
    type=str,
    default="pytorch/repvgg_b3g4",
    help="image embedding model",
)
...
parser.add_argument(
    ...
    type=str,
    default="image_text",
    help="no_aug, image_text, image_only, text_only",
)
# multimodal
parser.add_argument(
    "--method",
...
parser.add_argument(
    "--poe_unimodal_elbos", type=bool, default=True, help="unimodal_klds"
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=float,
    default=0.0,
    help="default initial weight of sum of weighted divergence terms",
)
parser.add_argument(
    "--beta_style",
    type=float,
...
parser.add_argument(
    "--lambda1", type=float, default=0.001, help="default weight of intra_mi terms"
)
parser.add_argument(
    "--lambda2", type=float, default=0.001, help="default weight of inter_mi terms"
)
...
image_dir_train = os.path.join(
    data_dir_root,
    "visual_feature/ImageNetTraining",
    FLAGS.image_model + "-PCA",
    FLAGS.sbj,
)
text_dir_train = os.path.join(
    data_dir_root, "textual_feature/ImageNetTraining/text", FLAGS.text_model, FLAGS.sbj
)

train_brain = sio.loadmat(
    os.path.join(brain_dir, "fmri_train_data" + FLAGS.stability_ratio + ".mat")
)["data"].astype("double")
...
parser.add_argument(
    "--m1_dim", type=int, default=dim_brain, help="dimension of modality brain"
)
parser.add_argument(
    "--m2_dim", type=int, default=dim_image, help="dimension of modality image"
)
parser.add_argument(
    "--m3_dim", type=int, default=dim_text, help="dimension of modality text"
)
