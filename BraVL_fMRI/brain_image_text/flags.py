...
"""
FLAGS TO HANDLE THE BRAIN IMAGE TEXT EXPERIMENT

"""

# DATASET NAME
parser.add_argument(
    "--dataset", type=str, default="Brain_Image_Text", help="name of the dataset"
)
# DATA DEPENDENT
...
parser.add_argument(
    "--num_hidden_layers", type=int, default=2, help="number of channels in images"
)
parser.add_argument(
...
parser.add_argument(
    "--likelihood_m3", type=str, default="laplace", help="output distribution"
)
...
parser.add_argument(
    ...
    type=float,
    default=1.0,
    help="default weight divergence term style modality 3",
)
parser.add_argument(
    "--beta_m1_rec",
    type=float,
    default=1.0,
    help="default weight reconstruction modality 1",
)
parser.add_argument(
    "--beta_m2_rec",
    type=float,
    default=1.0,
    help="default weight reconstruction modality 2",
)
parser.add_argument(
    "--beta_m3_rec",
    type=float,
    default=1.0,
    help="default weight reconstruction modality 3",
)
parser.add_argument(
