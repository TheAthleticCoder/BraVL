...
parser.add_argument(
    "--text_model", type=str, default="CLIPText", help="text embedding model"
)
parser.add_argument(
    "--image_model", type=str, default="pytorch/cornet_s", help="image embedding model"
)

parser.add_argument("--test_type", type=str, default="zsl", help="normal or zsl")
parser.add_argument(
    "--aug_type", type=str, default="no_aug", help="no_aug, image_text_ilsvrc2012_val"
)
...
text_dir_train = os.path.join(
    data_dir_root, "textual_feature/ThingsTrain/text", FLAGS.text_model, FLAGS.sbj
)

train_brain = sio.loadmat(os.path.join(brain_dir, "eeg_train_data_within.mat"))[
    "data"
].astype("double")
